...
static void merge(std::deque<std::pair<unsigned int, unsigned int> >& pairs, size_t left,
                  size_t mid, size_t right)
{
    ...
    std::deque<std::pair<unsigned int, unsigned int> > temp(totalElem);
...
void PmergeMeDeque::recursivelySortMainChain()
{
    if (pairs.size() > 1)
    {
...
void PmergeMeDeque::recursivelySortMainChain(std::deque<std::pair<unsigned int, unsigned int> >& pairs,
